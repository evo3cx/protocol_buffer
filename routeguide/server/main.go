...
// GetFeature return the feature at the given point.
func (s *routeGuideServer) GetFeature(ctx context.Context, point *pb.Point) (*pb.Feature, error) {
	...
	// No feature was found, retun an unnamed feature
...
// ROuteChat receives a stream of message/location pairs, and response with a
// stream of all, previous message at each of those locations.
